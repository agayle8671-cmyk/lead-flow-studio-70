...
const protocolResources: ResourceCard[] = [
  {
    ...
    downloadUrl: "/resources/map-user-guide.pdf",
  },
  {
    id: "excel-template",
    ...
    downloadUrl: "/resources/map-excel-template.xlsx",
  },
  {
    id: "lab-manual",
    icon: FlaskConical,
    ...
    downloadUrl: "/resources/audit-lab-manual.pdf",
  },
];
...
const clientToolkitResources: ResourceCard[] = [
  {
    ...
    downloadUrl: "/resources/health-grade-explainer.pdf",
    proOnly: true,
  },
  {
    id: "route-explainer",
    ...
    downloadUrl: "/resources/projected-route-guide.pdf",
    proOnly: true,
  },
];
